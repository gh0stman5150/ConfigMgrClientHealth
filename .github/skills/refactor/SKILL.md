...
3. **Version control is your friend** - Inspect changes and preserve a recovery point; create commits or branches only when the user requests them
...
1. PREPARE
   ...
   - Create a commit or branch only when explicitly requested
...
3. REFACTOR (small steps)
   ...
   - Run tests
   - Review the focused diff if tests pass
   - Repeat
...
5. CLEAN UP
   ...
   - Summarize validation and changes
```
